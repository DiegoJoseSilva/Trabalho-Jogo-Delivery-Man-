	...
	funcao inicio(){
		...
		enquanto (v[20]==0 e v2[20]==0){
			...
			escolha (rodar){
				...
				pare
				caso contrario: 
					escreva ("\nVocê desistiu e seu oponente venceu! Jogo finalizado!")
					se (JogadorAtual==1){
						v2[20]=1
					}senao{
						v [20]=1
			...
			se(JogadorAtual==1 e v[20]==0 e v2[20]==0){
				...
				JogadorAtual=2	
			}se(JogadorAtual==2 e v[20]==0 e v2[20]==0){
			...
			escreva ("Jogo finalizado com sucesso! Te vemos em breve!")
			}
		}
	}
/* $$$ Portugol Studio $$$ 
